                    ...
                    <div class="widget-area">
                        ...
                        <div class="sidebar-widget widget_categories mb-40">
                            ...
                            <div class="post-block-list post-module-1 post-module-5">
                                <ul>
                                    <li class="cat-item cat-item-2"><a href=" ">Beauty</a> (3)</li>
                                    <li class="cat-item cat-item-3"><a href=" ">Book</a> (6)</li>
                                    <li class="cat-item cat-item-4"><a href=" ">Design</a> (4)</li>
                                    <li class="cat-item cat-item-5"><a href=" ">Fashion</a> (3)</li>
                                    <li class="cat-item cat-item-6"><a href=" ">Lifestyle</a> (6)</li>
                                    <li class="cat-item cat-item-7"><a href=" ">Travel</a> (2)</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="sidebar-widget widget_alitheme_lastpost mb-20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('frontend/assets/imgs/blog/blog-3.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('frontend/assets/imgs/blog/blog-4.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('frontend/assets/imgs/blog/blog-5.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    <div class="post-thumb d-flex border-radius-5 img-hover-scale mb-15">
                                        <a href="blog-details.html">
                                            <img src="{{ asset('frontend/assets/imgs/blog/blog-6.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
