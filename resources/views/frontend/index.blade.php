                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            ...
                                            <img class="default-img" src="{{ asset('frontend/assets/imgs/shop/product-3-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            ...
                                            <img class="default-img" src="{{ asset('frontend/assets/imgs/shop/product-4-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            ...
                                            <img class="default-img" src="{{ asset('frontend/assets/imgs/shop/product-6-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="hover-img" src="{{ asset('frontend/assets/imgs/shop/product-9-1.jpg') }}"
                                                alt="">
                                            <img class="default-img" src="{{ asset('frontend/assets/imgs/shop/product-9-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
